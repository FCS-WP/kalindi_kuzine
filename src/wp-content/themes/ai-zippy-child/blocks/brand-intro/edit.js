...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title="Hero Slider Images" initialOpen={true}>
              ...
              render={({ open }) => (
                <div>
                  ...
                  <Button
                    ...
                    style={{ width: "100%" }}
                  >
                    {heroImageUrl ? "Replace Image 1" : "Select Image 1"}
                  </Button>
                  {heroImageUrl && (
                    <Button
                      variant="link"
              ...
              render={({ open }) => (
                <div>
                  ...
                  <Button
                    ...
                    style={{ width: "100%" }}
                  >
                    {heroImageUrl2 ? "Replace Image 2" : "Select Image 2"}
                  </Button>
                  {heroImageUrl2 && (
                    <Button
                      variant="link"
                      isDestructive
                      onClick={() =>
                        setAttributes({ heroImageId2: 0, heroImageUrl2: "" })
                      }
                      style={{ marginTop: 4 }}
                    >
                      Remove
      ...
      <div {...blockProps}>
        ...
        <div className="bi__story" style={{ backgroundColor: bgColor }}>
          ...
          />
          {linkText && <span className="bi__link">{linkText} &rarr;</span>}
        </div>
      </div>
    </>
  );
